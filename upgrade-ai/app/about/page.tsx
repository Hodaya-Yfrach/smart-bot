...
export default function AboutPage() {
  const features = [
    ...
    },
    {
      ...
      desc: 'הפעילי מצב לימודים בשיחה מסוימת כדי לקבל הערכת דיוק באחוזים אחרי כל תשובה וממוצע מצטבר. אפשר לבחור שאלות רק מתוך תשובת ה-AI הנוכחית, או שאלות לפי הנושא שביקשת עם ידע כללי קשור בלבד. המצב נשאר רק בשיחה הנוכחית.',
    },
    {
      icon: '💡',
      title: 'חלון התייעצות',
