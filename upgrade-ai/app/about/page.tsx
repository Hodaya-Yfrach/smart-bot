...
export default function AboutPage() {
  const features = [
    ...
    },
    {
      ...
      desc: 'העלי תמונה לצד השאלה וה-AI יוכל לנתח אותה ולהתייחס אליה בתשובה. נתמכים JPEG, PNG, WebP ו-GIF.',
    },
    {
      icon: '📄',
      title: 'תקציר שיחה חכם',
      desc: 'לחץ "תקציר" בסוף שיחה — המערכת מייצרת סיכום עם נקודות מרכזיות ומושגים חדשים, ושומרת אותו ב-DB. פתיחה חוזרת מציגה את השמור ישר, ו-🔄 מאפשר עדכון.',
    },
    {
      icon: '🧠',
      title: 'זיכרון וכללים',
      desc: 'הגדר כללים קבועים שתקפים לכל השיחות ("תמיד תענה בעברית") וכללים ספציפיים לשיחה אחת. הכללים משפיעים על כל תשובה.',
    },
    {
      icon: '🎓',
      title: 'מצב לימודים זמני',
      desc: 'הפעל מצב לימודים בשיחה מסוימת כדי לקבל הערכת דיוק באחוזים אחרי כל תשובה וממוצע מצטבר. אפשר לבחור שאלות רק מתוך תשובת ה-AI הנוכחית, או שאלות לפי הנושא שביקשת עם ידע כללי קשור בלבד. המצב נשאר רק בשיחה הנוכחית.',
    },
    {
      icon: '💡',
      title: 'חלון התייעצות',
    ...
    },
    {
      ...
      desc: 'לחץ "עריכת שאלה" בהודעה האחרונה — הטקסט חוזר לתיבת הקלט, ההמשך נמחק מה-DB, ואפשר לשלוח מחדש עם שינויים.',
    },
    {
      icon: '🔄',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500 max-w-xl mx-auto leading-relaxed">
            סביבת עבודה חכמה המבוססת על Gemini — שיחה, זיכרון וסיכומים, הכל במקום אחד.
          </p>
        </div>
