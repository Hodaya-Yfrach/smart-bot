// =============================================================================
// app/api/quick-summary/route.ts — POST /api/quick-summary
// מחזיר כותרת קצרה (עד 7 מילים) לפרומפט בודד — משמש לכותרות שיחה אוטומטיות.
// DEV NOTE: הבקשה יוצאת רק מהשרת שלנו — המפתח לא חשוף לדפדפן.
// =============================================================================
