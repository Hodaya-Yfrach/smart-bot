...
const steps = [
  ...
  },
  {
    ...
    text: 'לחצי על הכפתור למטה. ייפתח אתר של Google בחלון חדש. זה אתר רשמי של Google, ולא צריך לדעת תכנות כדי להשתמש בו.',
  ...
  },
  {
    ...
    text: 'אם מופיע מסך התחברות, הזיני את כתובת Gmail שלך ולחצי על הבא. לאחר מכן הזיני את הסיסמה ולחצי שוב על הבא. אם יש אימות בטלפון, אשרי אותו לפי ההוראות של Google.',
    visual: 'login',
  },
  {
    title: 'יוצרים ומעתיקים את המפתח',
    text: 'בעמוד שנפתח חפשי כפתור בשם Create API key או יצירת מפתח API. לחצי עליו, המתיני כמה שניות, ואז לחצי על סמל ההעתקה ליד המפתח. אין צורך לבחור פרויקט או לשנות הגדרות.',
    visual: 'key',
  },
  {
    title: 'מדביקים באתר',
    text: 'חזרי לאתר, פתחי הגדרות, הדביקי את המפתח בשדה מפתח API אישי ולחצי על שמירת שינויים. מעכשיו הבקשות שלך ישתמשו במפתח האישי שלך.',
    visual: 'paste',
  },
];
